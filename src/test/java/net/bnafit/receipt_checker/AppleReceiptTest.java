...
public class AppleReceiptTest {
	...
	public void testJsonConversion() {
		...
		assertTrue("{\"receipt-data\":\"Zm9v\",\"password\":\"bar\",\"exclude-old-transactions\":true}".equals(receipt.toJson().toString()));
		AppleReceipt receipt2 = new AppleReceipt("foo", "bar", null);
		assertTrue("{\"receipt-data\":\"Zm9v\",\"password\":\"bar\"}".equals(receipt2.toJson().toString()));
	}
}
